...
import com.example.demo.correccion.service.ICuentaBancariaServic;
import com.example.demo.correccion.service.ITransferenciaServic;
...
public class Prueba1PaP3ScApplication implements CommandLineRunner{
	...
	@Autowired
	private ITransferenciaServic iTransferenciaService;
...
//		this.iCuentaBancariaService.crear(bancaria2);
		...
		this.iTransferenciaService.realizar("123", "456", new BigDecimal(100));
		
		//parte tres
		
		CuentaBancari bancaria3=this.iCuentaBancariaService.conseguir("123");
